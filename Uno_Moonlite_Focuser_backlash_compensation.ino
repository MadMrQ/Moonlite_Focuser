...
Commands (use in Serial Monitor)
...
: Z X X #         XX#         Get TempComp threshold
...
#define                PIN_DIRECTION 3                     // Motor pins, A4998
#define                PIN_STEP 2
/*
#define                PIN_OUTPUT_MOTOR1 2                 // Motor pins ULN2003
...
// TempComp coefficient is signed integer
...
void setup()
{
  ...
  if(Backlash!= Backlash!=BACKLASH_FPTN||Backlash!=0)
    Backlash = 0;
  ...
  if (eoc) {
    ...
    if (!strcasecmp(cmd, "FG")) {
      ...
      //if (!TempCompEn)
      {
        ...
        if(debug)
        {
//          snprintf(tempString, sizeof(tempString), "C%04X T%04X B%+04X",(int)CurrentPosition,(int)TargetPosition,(int)Backlash);
//          Serial.println(tempString);
          //Serial.print("Movement Commanded"); Serial.println("");
          //Serial.print("Current Position: "); Serial.print(CurrentPosition); Serial.println("");
          //Serial.print("Target Position: "); Serial.print(TargetPosition); Serial.println("");
          //Serial.print("Backlash: "); Serial.print(Backlash); Serial.println("");
         }
        
        // If moving outward use backlash compensation 
        ...
        if(TargetPosition > CurrentPosition) 
        {
         // BacklashComp = true;
          ...
          //Serial.print("Backlash Compensated?"); Serial.println("");
          //delay(5000);
          }
        else
        {
          stepper.moveTo(TargetPosition);
          //Serial.print("Target < Current"); Serial.println("");
        }
        ...
        if(debug)
        {
          Serial.print("Movement Ended"); Serial.println("");
          Serial.print("Current Position: "); Serial.print(CurrentPosition); Serial.println("");
          Serial.print("Target Position: "); Serial.print(TargetPosition); Serial.println("");
          //snprintf(tempString, sizeof(tempString), "C%04X T%04X B%+04X",(int)CurrentPosition,(int)TargetPosition,(int)Backlash);
          //Serial.println(tempString);
